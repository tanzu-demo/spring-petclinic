...
┃ ┃ ┃ ┃ ┃ Debug kubernetes/tap/Tiltfile matched [pom.xml, readme.md, kubernetes/**, catalog/*.yaml, .github/**, build.gradle*, settings.gradle*, gradlew*, gradle/**] -> excluded
...
┃ ┃ ┃ ┃ ┃ Debug .editorconfig didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug .github/workflows/maven-build.yml didn't match [kubernetes/tap/Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ Debug LICENSE.txt didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug build.gradle.skip didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug catalog/catalog-info.yaml didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug docker-compose.yml didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug gradle/wrapper/gradle-wrapper.jar didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug gradle/wrapper/gradle-wrapper.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug gradlew didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug gradlew.bat didn't match [kubernetes/tap/Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ Debug settings.gradle.skip didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/checkstyle/nohttp-checkstyle-suppressions.xml didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/checkstyle/nohttp-checkstyle.xml didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/PetClinicApplication.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/model/BaseEntity.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/model/NamedEntity.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/model/Person.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/model/package-info.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/Owner.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/OwnerController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/OwnerRepository.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/Pet.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/PetController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/PetRepository.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/PetType.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/PetTypeFormatter.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/PetValidator.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/owner/VisitController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/system/CacheConfiguration.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/system/CrashController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/system/WelcomeController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/vet/Specialty.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/vet/Vet.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/vet/VetController.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/vet/VetRepository.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/vet/Vets.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/visit/Visit.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/org/springframework/samples/petclinic/visit/VisitRepository.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application-mysql.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application-postgres.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/banner.txt didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/h2/data.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/h2/schema.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/hsqldb/data.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/hsqldb/schema.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/mysql/data.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/mysql/petclinic_db_setup_mysql.txt didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/mysql/schema.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/mysql/user.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/postgres/data.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/postgres/petclinic_db_setup_postgres.txt didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/db/postgres/schema.sql didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/messages/messages.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/messages/messages_de.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/messages/messages_en.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/messages/messages_es.properties didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/css/petclinic.css didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/montserrat-webfont.eot didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/montserrat-webfont.svg didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/montserrat-webfont.ttf didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/montserrat-webfont.woff didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/varela_round-webfont.eot didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/varela_round-webfont.svg didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/varela_round-webfont.ttf didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/fonts/varela_round-webfont.woff didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/favicon.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/pets.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/platform-bg.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/spring-logo-dataflow-mobile.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/spring-logo-dataflow.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/resources/images/spring-pivotal-logo.png didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/error.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/fragments/inputField.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/fragments/layout.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/fragments/selectField.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/owners/createOrUpdateOwnerForm.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/owners/findOwners.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/owners/ownerDetails.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/owners/ownersList.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/pets/createOrUpdatePetForm.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/pets/createOrUpdateVisitForm.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/vets/vetList.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/welcome.html didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/scss/header.scss didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/scss/petclinic.scss didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/scss/responsive.scss didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/scss/typography.scss didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/PetclinicIntegrationTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/model/ValidatorTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/owner/OwnerControllerTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/owner/PetControllerTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/owner/PetTypeFormatterTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/owner/VisitControllerTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/service/ClinicServiceTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/service/EntityUtils.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/system/CrashControllerTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/vet/VetControllerTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/test/java/org/springframework/samples/petclinic/vet/VetTests.java didn't match [kubernetes/tap/Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┗ Debug src/test/jmeter/petclinic_test_plan.jmx didn't match [kubernetes/tap/Tiltfile] -> excluded
